...
import company.vk.edu.distrib.compute.luckyslon2003.LuckySlon2003AuditServiceFactory;
import company.vk.edu.distrib.compute.luckyslon2003.LuckySlon2003AuditableKVServiceFactory;
...
public class AuditServiceFactoryArgumentsProvider implements ArgumentsProvider {
    private final Set<ImmutablePair<Class<? extends KVServiceFactory>, Class<? extends AuditServiceFactory>>>
            factories = Set.of(
            ImmutablePair.of(LuckySlon2003AuditableKVServiceFactory.class, LuckySlon2003AuditServiceFactory.class)
    );
